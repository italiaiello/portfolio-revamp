    ...
    return (
        <section className="end-section section center-column">
            ...
            <article className="end-section__btn-container center-row">
                <a href="https://github.com/italiaiello" className="btn end-section__btn-container--btn center-row">
                    <figure className="center-row">
                        <img src={GitHubLogo} alt="GitHub" />
                    </figure>
                </a>
                <a href="https://www.linkedin.com/in/andrew-aiello-9aa21417a/" className="btn end-section__btn-container--btn alternate-btn center-row">
                    <figure className="center-row">
