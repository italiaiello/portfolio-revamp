        ...
        <section className="header">
            ...
            <article className="header__intro center-column">
                ...
                <article className="header__intro--btn-container center-row">
                    <a href="https://github.com/italiaiello" className="btn header__intro--btn alternate-btn center-row">
                        <figure className="center-row">
                            <img src={GitHubLogo} alt="GitHub" />
                        </figure>
                    </a>
                    <a href="https://www.linkedin.com/in/andrew-aiello-9aa21417a/" className="btn header__intro--btn center-row">
                        <figure className="center-row">
